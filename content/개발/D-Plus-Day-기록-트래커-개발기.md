---
title: "D+Day — \"나 머리 언제 잘랐지?\" 이발 주기 헷갈려서 만든 D+ 트래커 개발 회고"
description: "D-Day는 미래를 세지만 우리는 과거를 잊는다. 이발, 아기 손발톱, 칫솔 교체 주기부터 Safari ITP 차단 우회까지 일상의 불편함을 코딩으로 해결한 D+Day 개발기."
date: 2026-07-27
tags:
  - 개발
  - 프로젝트회고
...
# ⏳ D+Day — "나 머리 언제 잘랐지?" 이발 주기 헷갈려서 만든 D+ 트래커 개발기
...
## 💡 1. 기획 배경 — "도대체 나 마지막으로 이발한 게 언제더라?"
...
## 💥 4. 트러블슈팅 — Safari ITP 차단 우회와 Firebase Hosting 전환기
...
## ⚖️ 5. 분산 환경의 데이터 충돌 및 삭제 처리 (Tombstone 패턴)
