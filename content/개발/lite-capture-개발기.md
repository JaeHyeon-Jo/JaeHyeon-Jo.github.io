---
title: "lite-capture — 이미 있는 기능이라도 내 입맛대로: 설치 없는 10MB 초경량 캡처·GIF 녹화 도구 개발기"
description: "AI로 어디까지 되는지 호기심에 시작해 나만의 유틸리티까지. 기존 기성 제품 대신 내가 원하는 핵심 기능(캡처, 빨간 박스, 화면 고정, GIF 녹화)만 조합한 LiteCapture 개발 회고."
date: 2026-07-28
tags:
  - 개발
  - 프로젝트회고
...
# 📸 lite-capture — 이미 있는 기능이라도 내 입맛대로: 설치 없는 10MB 초경량 캡처·GIF 녹화 도구 개발기
...
## 🎯 2. 핵심 철학 — "이미 있는 기능이지만, 내가 쓰기 가장 편하게"
...
## 🛠️ 4. 기술 아키텍처 — Win32 API & Qt 네이티브 연동
...
## 💥 5. 트러블슈팅 — SmartScreen 경고와 단일 인스턴스 뮤텍스

### 🚨 이슈 1. Windows SmartScreen "PC 보호" 경고
...
## 📦 6. GitHub Actions를 통한 CI/CD 단일 실행 파일 자동 배포
